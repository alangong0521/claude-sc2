...
## O408 Power / O409 Timing 正式胜局

- `o408b` Power：**Victory 2097.6s**。二矿233.0s、三矿425.9s；首暴风
  409.8s、首不朽433.9s。506/619/844/1012s舰队2/3/8/17；双不朽让
  517s级早波不再穿，终局24暴风+4航母+2不朽。Power最近5个有效样本
  为o402胜、o403负、o404胜、o406负、o408胜，即 **3/5，正式打穿**。
- `o409a` Timing：**Victory 1148.4s**。二矿172.8s；506s舰队3仍2基地，
  558.5s舰队5+双不朽后才开三矿，O407门通过。三矿后战损但舰队从
  619/731/788/956/1069s的4/8/11/16/23持续增长，终局19暴风+5航母+
  2不朽，证明O409恢复并行方向成立。
- Timing因此前连续败局，动态最近5局当前仍 **1/5**；接下来需要两场连续
  胜局把窗口推到3/5。Power已完成，不再占主lane。

### 下一轮：O410 Timing双lane决胜

- 两条lane都跑VeryHard Terran Timing×1；若双胜，窗口变为
  `负、负、胜、胜、胜`=3/5，Timing与Power双目标同时完成。
- 验收：舰队4前三矿0；掉矿时若仍≥2基地/舰队≥4，零`rebuild_nexus`停产，
  舰队曲线持续增长；残敌阶段O403地图轮巡收敛终局。

## O410 Timing 双 lane（1胜1负，窗口2/5）

- `o410a`：**Victory 1027.1s**。二矿172.8s；舰队4前严格2基地，
  658.9s舰队6后才开三矿。619/731/900/1012s舰队3/8/10/19，终局
  17暴风+3航母+2不朽。胜局录像仍暴露三/四矿658.9/679.0s仅隔20s，
  舰队6时双开把2700矿银行瞬间转成两个裸矿，虽本局获胜但风险不必要。
- `o410b`：**Defeat 1217.1s**。二矿233.0s；舰队4前严格2基地，715.2s
  舰队7后开三矿。881s敌87 supply vs我57，1087s下一波86 supply vs我56；
  两波间隔约206s。1077.7s敌信用已衰减为0，O302舰队8出门，10s后第二波
  到家，最终经济/舰队被压垮。中期还出现矿1320/气116、4星门的气体瓶颈。
- 动态最近5局为o406负、o408负、o409胜、o410a胜、o410b负，即 **2/5**；
  下一有效胜局可达到3/5。

### O411 已落地（胜局与败局共同尸检的3项优化）

1. **Terran Timing敌军信用窗120→240s**：覆盖实测206s波次间隔，阻止上一波
   信用刚过期就O302出门；同一信用同时驱动塔地板和出发闸。
2. **舰队12前扩张单片串行**：`expansion_max_pending`即使因矿>1250返回2-3，
   Terran Timing舰队<12时最终压1；避免o410a胜局三/四矿20s双开的风险。
3. **舰队8前禁止停气转矿**：Terran Timing在场舰队<8时O359不触发，把四气
   收入优先转暴风/航母；达到8后恢复原矿气倒挂判据，非Timing组合不变。
4. 三项各有独立纯函数与单测；下一局必须同时验收240s信用、扩张max_pending=1、
   舰队8前零O359停气事件。

## O411 Timing 决胜局（Victory 1791.6s，窗口3/5）

- 首次尝试在恢复胜势中SC2异常退出，属无效样本；自动重试为正式
  **Victory 1791.6s**。二矿192.9s；舰队4前严格2基地，602.7s舰队5后
  三矿，779.5s舰队9后四矿。619/731/844/1012s舰队5/6/13/24。
- 1061-1125s连续掉两座分矿后，O410通过：基地4→2但舰队27→18→20，
  未出现恢复基金把舰队钉死；随后舰队重新增长到30并终结。
- O403残敌终结1494.3s触发，最终1791.6s结束。Timing最近5个有效样本为
  o408负、o409胜、o410a胜、o410b负、o411胜，即 **3/5，正式打穿**。
- Power已于O408达到3/5；至此司令指定的Terran Timing与Power双目标均完成。

### O412 已落地（O411胜局单独尸检的3项优化）

1. **强推读取敌军信用**：Terran Timing的`_force_push`若我方army supply低于
   240s信用敌军则撤销，封住普通出发闸之外的旁路。
2. **四矿等舰队12**：三矿仍按舰队4+双不朽；已有3基地后，真实舰队<12时
   所有开矿出口封第四，避免O411胜局舰队9就开四矿并在大波中双掉矿。
3. **Terran更早残敌终结**：仅Terran把终结阈值放宽到结构≤15、工人≤20；
   作战单位≤12、t≥1200、舰队≥16三道安全门不变，目标提前清生产资料。
4. 三项分别有纯函数/单测。按CLAUDE.md新硬门，再跑1局O412确认样本；无论
   胜负都必须再次完成有效局尸检，当前3/5认证动态维护。

## O412 确认样本（Defeat 844.2s；认证仍3/5）

- 首次尝试优势局SC2异常退出，无效；自动重试为正式 **Defeat 844.2s**。
  二矿184.8s；341s一架Banshee显形，381s全局8塔但二矿局部0塔，409.8s
  二矿被拆。之后基地恢复基金暂停舰队科技，终局全失。
- 该局没有任何Tempest/Carrier出场；437.9s仍花275矿出首不朽，而Banshee
  是唯一可见威胁。FB多次no_money/保险丝释放，气体最终1532、矿物不足，
  说明O411“舰队8前不停气”在FB未建立的异常链中方向相反。
- 动态最近5局为o409胜、o410a胜、o410b负、o411胜、o412负，即
  **3/5，Timing认证保持**。Power同样3/5。

### O413 已落地（O412有效败局的3项优化）

1. **早期空军局部防御**：Terran Timing/Power可见空中作战单位>0时，最终
   PSD目标保证主基/每分矿≥2炮塔、每基地≥1电池；全局8塔不再掩盖裸二矿。
2. **空军显形暂停无条件双不朽**：Timing/Power预产双不朽仅在可见空军=0时
   无条件成立；若Marauder/Tank/Thor重甲≥6，仍无视空军恢复不朽生产。
3. **FB未建立时允许停气自救**：O411气阀保护增加`fleet_tech_ready`，只有FB
   实体已存在且舰队<8才禁止停气；FB缺失时恢复O359矿气倒挂逻辑，把烂气
   工人拉回矿线攒FB/首舰矿物。
4. 三项均有独立纯函数/单测；作为已完成战役的后续改进留给下一次验证，当前
   不再追加会改变矩阵窗口的样本。

## 司令新目标（2026-08-22）

1. 旧认证组合 Zerg Macro/Air、Terran Macro/Air 全部从零重新计样本；每组
   必须最近5局≥3胜且取得3连胜才正式打穿。
2. 四组完成后重启VeryHard Zerg Timing，直到取得稳定3连胜。
3. 所有有效胜/负/平局继续执行CLAUDE.md新硬门：日志+state+录像、每局至少
   3项优化实际落地、测试、battle-log、commit+push后才启动新lane。

## O414 Macro 首轮（Zerg 0胜1负；Terran 1胜0负）

### o414a Zerg Macro（Defeat 2489.7s）

- 二矿148.7s、三矿337.5s、四矿429.9s；788s舰队16，1238s舰队29，
  经济/舰队前中期均优势。但bank滚雪球突破flows.yml cap，1012s已11星门，
  塔峰31，投资面失控。
- 700s后腐化10，1583s又有13腐化；追猎早期峰13但后期持续战损未回补，
  2250s只剩11暴风，2419s舰队归零。
- 1546s后每掉基地均触发恢复基金，11星门+数千资源仍暂停产兵；最终电脑
  依靠腐化/大龙/地面海重建翻盘。新认证连胜=0。

### o414b Terran Macro（Victory 865.7s）

- 二矿233.0s、三矿393.8s、四矿546.4s；401.8s首暴风，506/562/731/844s
  舰队4/7/13/20，终局19暴风+3航母。
- 四矿舰队7时落地，582s即被4地面抄、585s 10地面再压；局部0-1塔，虽本局
  靠舰队获胜，但扩张放行偏早。
- 619s气813、舰队8但星门从4掉到3，直到731s才恢复4；产能战损恢复存在
  约110s缺口。新认证连胜=1。
...
1. 当前≥3基地且真实舰队≥12时，掉矿不触发lost_base/base_rebuild全局停产。
2. bank补产目标显式传`flows.yml extra_production.cap`，carrier星门不再突破8。
3. 追猎护航扩到Macro：t≥700、舰队≥8时持续补到12追猎。

Terran Macro：

1. 第四基地需真实舰队≥8。
2. 第四基地放行还要求所有现有就绪基地局部炮塔最薄值≥1。
3. FB就绪、舰队≥4时维持4星门地板；SG<4且150矿/300气在手即critical重建。

## O415 Macro 第二轮（Zerg 1胜0负；Terran 2连胜）

### o415a Zerg Macro（Victory 934.6s）

- 二矿约早期完成，650/767/864/928s舰队8/16/23/23；追猎护航从650s后
  1→5→7→10，腐化未能重建，终局17暴风+6航母+10追猎。
- 星门全程≤6，O414配置cap收口通过；没有重现11星门/恢复基金停产翻盘。
- 胜局仍有优化空间：807s敌工蜂56，经济斩断只对Rush生效；追猎到终局仍
  未达12；934s结束前残余18工蜂+少量建筑尚未进入1200s终结模式。
- 新认证连胜：**1**。

### o415b Terran Macro（Victory 3344.1s）

- 首次尝试在26舰队对11 SCV的胜势清场阶段SC2异常退出，无效；自动重试
  为正式胜局。重试四矿在舰队8且既有矿均有塔后放行，4星门恢复地板生效。
- 中局多次清空敌主力，最终33暴风+4航母；但曾只剩1 SCV+1 CC，终结模式
  被40+迷雾记忆结构挡住，电脑重新攒出维京/战巡/坦克，游戏拖到3344s。
- 新认证连胜：**2**。
...
1. 主动经济打击从Rush扩到Macro，Macro从650s/舰队8起斩最外围孵化场。
2. Macro追猎护航启动700→650s。
3. Macro追猎混入比例0.2→0.3，加速达到12追猎线。

Terran Macro：

1. 终结判据的结构数改为当前可见结构，不再被迷雾记忆结构永久挡住。
2. Macro终结最早时间1200→900s。
3. Macro终结阈值放宽为可见结构≤20、工人≤30、作战单位≤20；舰队≥16硬门
   保持。Zerg Macro另用900s/结构≤10/工人≤20/作战≤12档。

## O416 Macro 第三轮（Zerg 2连胜；Terran 3连胜打穿）

### o416a Zerg Macro（Victory 874.4s）

- 二矿140.6s、三矿325.4s、四矿454.0s；619/731/844s舰队10/15/21。
  追猎从600s后快速补到11，终局18暴风+5航母+11追猎；敌尖塔未能转化腐化海。
- 胜局仍暴露塔峰32（约4800矿），舰队12后继续铺塔；835s敌20工蜂+少量
  建筑，900s终结门尚未到，仍有74s可压缩。
- 新认证连胜：**2**。

### o416b Terran Macro（Victory 1113.5s）

- 首次尝试胜势清场崩溃，无效；重试二矿217.0s、三矿381.7s、四矿
  695.1s。第四门验收通过；506/675/844/1012s舰队2/7/17/26。
- 900s新版终结模式准时触发，正式局1113.5s结束；相较o415的3344.1s
  缩短2230s，说明可见结构口径/900s档有效。新认证3连胜：
  **o414胜→o415胜→o416胜，Terran Macro正式打穿**。
- 终结事件因可见结构/敌军抖动在900-1047s刷出数十条；终结期仍于1096.9s
  开第五矿并继续扩产，属于无关消费。
...
1. 追猎护航启动650→600s。
2. Macro终结最早时间900→800s。
3. 舰队≥12后Zerg Macro全局炮塔（含生存豁免通道）硬顶20。

Terran Macro：

1. 终结模式下`_want_dynamic_expand`直接False，不再开新矿。
2. 终结模式下`_build_extra_production`与`_spend_bank`直接返回，不再扩产。
3. O403终结事件改30s节流，敌情抖动不再逐帧刷屏。

## O417 Zerg Macro 第四轮（Defeat 1485.0s；连胜归零）

- `o417a`为正式有效败局。录像显示电脑二矿84.4s，我方二矿139.1s；我方
  三/四矿321.5/413.2s，其中四矿完成时仍是0真实舰队。state中413.8s仅
  1叉、4基地，说明经济投资明显早于核心战力。
- 舰队到731.2s才达到本局峰值11（9暴风+2航母）；831-836s连续掉两矿，
  基地4→2并出现`O126:产兵暂停=rebuild_nexus`。此后900/956s舰队均仅6，
  恢复基金反复暂停生产，没有利用6星门和现有舰队维持补员。
- 980.4s我方仅6暴风，对面可见16腐化+3刺蛇；1068.8s舰队归零，最终
  0基地、0农民、仅余1先知。新认证序列为
  **负→胜→胜→负**，最近4局2胜2负、当前连胜=0，尚未打穿。

### O417 已落地（有效败局的3项优化）

1. **四矿等待真实舰队4**：新增`zerg_macro_fourth_blocked`，在Zerg Macro
   已有3基地但暴风+航母<4时，统一封住计划层、动态扩张和bank扩张三个出口；
   避免再次以0舰队完成四矿。
2. **成型舰队更早并行补矿**：Zerg Macro掉矿基金豁免从“≥3基地且舰队≥12”
   收紧为“当前≥2基地且舰队≥8”；保留只剩1基地时的生存优先，同时防止
   o417中基地4→2、仍有9舰队时被全局停产。
3. **闲置Gateway直补追猎护航**：Macro后期达到既有护航条件但追猎不足12时，
   允许就绪闲置Gateway直接生产1个追猎，不再只依赖bank混兵路径；目标是
   对16腐化海持续保有地面护航，减少纯暴风被贴脸清零。
4. 验证门：`py_compile`通过；定向`592 passed`；完整项目测试
   **923 passed, 1 skipped**；生产模块import smoke通过。下一局重点验收：
   舰队4前基地≤3、基地跌至2但舰队≥8时无`rebuild_nexus`产兵暂停、追猎
   在后期持续向12增长。

## O418 Zerg Macro 第五轮（Defeat 1169.9s；最近5局2/5）

- 首次尝试约1274s败势残局中SC2异常退出，无有效结果，不计样本；自动重试
  产生正式 **Defeat 1169.9s**。录像中电脑二矿104.6s、我方148.0s；我方
  三矿312.8s。O417四矿闸通过：450s仍是3基地、0舰队，未提前开四矿。
- 但放行后扩张再次失控：录像中四/五矿587.3/594.6s只隔7.3s，687.3/
  687.5s又并行拍两座Nexus；state峰值6基地但农民仅64-70。619s已有4基地、
  6舰队仍因峰值5→当前4触发`rebuild_nexus`停产；687s舰队7、4基地，矿物
  已从3495涨到本局峰值5050，自动复盘确认`stall(停产68s)`。
- 产能投资也早于兵力：450s为1星门/0舰队/1985矿612气；506s已4星门但
  仅1暴风；562s为5星门、3暴风、4005矿12气。额外星门消耗首批舰队所需气，
  多余矿随后被并发基地和塔阵吸收，731/788s塔已21/27座。
- 737.8s仅10舰队且敌空军当帧不可见时触发`O390`主动斩分矿；787.5s舰队
  峰值12。803.6s敌14腐化显形后我方开始连续掉暴风，823.7s已只剩2暴风，
  约36s内核心舰队基本清零。终局0基地、3农民、仅1先知。
- 新认证五局为 **负→胜→胜→负→负**，最近5局 **2胜3负**、当前连胜0，
  Zerg Macro仍未打穿。

### O418 已落地（有效败局的4项优化）

1. **6舰队即可并行重建**：Zerg Macro掉矿基金豁免从舰队≥8降到≥6，基地≥2
   安全门不变；直接覆盖619-687s的4基地/6-7舰队/68s停产窗，只剩1基地或
   舰队≤5时仍优先攒Nexus。
2. **分阶段基地帽并串行扩张**：真实舰队<4最多3基地、<12最多4基地、<16
   最多5基地；舰队16前`max_pending`强制1。计划层、动态扩张和bank旁路共用
   同一上限，封住四/五矿7s双开与687s双Nexus并发。
3. **首批舰队前星门硬顶3**：Zerg Macro真实舰队<4时，第4+星门在常规追加
   与bank追加两条路径都让位；避免再次出现5星门只产3暴风、气体降到12。
4. **Macro经济打击等16舰队**：Rush仍保持8舰队线，Macro从8提高到16；
   防止敌腐化暂时不可见时以10舰队盲斩分矿，给追猎护航和舰队临界质量留窗。
5. 验证门：`py_compile`通过；定向`592 passed`；完整项目测试
...
## O420 Zerg Macro 第七轮（Defeat 1251.8s；败因转到防守交战）

- 正式有效 **Defeat 1251.8s**。O419根修通过：首SG约225s、首暴风421.9s、
  首航母566.5s；相较o419首暴风831.7s前移409.8s，峰值存款8945→2540。
  首批舰队<4期间394/450/506s塔为6/6/9，常规塔未越10顶；runner无worker
  卡步事件，说明配置删尾+45s接管兜底均未再死锁。
- 新主因是过早普通推进。657.7s仅6舰队、2追猎即触发
  `O302:先手压制推进`；这不是已收紧到16舰队的`O390`经济打击，而是普通
  `_army_gate_ok`路径仍使用5舰队地板。683.7s又在约9舰队时完成四矿，把
  战线和掩体拉到外侧薄防区。
- 719.2s我方9暴风+2航母、仅1追猎，对面已可见8腐化；755.4s对面13腐化+
  7刺蛇时，我方仍在外侧交战。现有Tempest微操只在腐化进入每艘15格查询圈
  后才撤，并选择“离自己最近”的单塔/电池；没有利用主矿4塔+5电池的最强簇。
- 两航母于755-763s间消失；779.5/783.5/787.5s连续损失2/3/2暴风，舰队
  从731s峰值11跌到788s仅2。此后掉矿基金在低舰队状态下按设计停产攒Nexus，
  但已无核心兵力可翻盘；1012s舰队0，终局0基地、1农民、0军队。
- 新认证序列为 **负→胜→胜→负→负→负→负**；滚动最近5局现为
  **1胜4负**、连胜0，Zerg Macro仍未打穿。

### O420 已落地（有效败局的4项优化）

1. **Zerg Macro全部出击统一16舰队门**：新增组合专用push floor；普通
   `_army_gate_ok`路径和`t>540`强推路径都读取16，在场口径不含在产。封住
   o420的6舰队普通O302；Timing/Rush/Terran等原5/6/8门不变。
2. **追猎护航提前100s并降启动舰队线**：Macro从600s/舰队8改为500s/舰队4，
   12追猎目标不变；目标是在首批腐化719s出现前，而不是716s后，启动双兵营
   直补护航。
3. **全局腐化预撤到最强掩体**：可见腐化≥4或飞蛇>0时，不等敌进入单舰15格
   圈就撤；掩体按8格内塔权重1、电池权重2计算局部火力簇，优先主矿/二矿
   集中阵地，距离只作同分项。地面刺蛇撤退也复用最强簇，不再选最近单塔。
4. **扩张继续后移**：Zerg Macro四/五/六矿放行线从舰队4/12/16提高到
   12/16/20，舰队16前仍严格逐矿串行；三矿经济先形成16舰队与追猎护航，
   不再为687s外侧四矿牵引主力。
5. 验证门：`py_compile`通过；生产/战斗定向 **635 passed**；完整项目测试
   **928 passed, 1 skipped**；production/combat/tempest/main import smoke通过。
   下一局验收：舰队<16零O302/O390、舰队<12基地≤3、500s/舰队4后追猎持续
   增长，以及腐化≥4时暴风向最强塔电簇撤退而非在外矿接战。

## O421 Zerg Macro 第八轮（Defeat 1346.7s；强掩体延缓但未反杀）

- 正式有效 **Defeat 1346.7s**。O420四项门均通过：全局无O302/O390；基地
  峰值3；追猎直补从602.9s持续触发；首暴风446.0s。舰队团灭从o420的
  779-1012s阶段整体后移到o421的956-1012s，峰值存款仅690，说明集结与
  强掩体撤退确实延长了有效战斗窗。
- 但配方仍不足。916.1s我方9暴风+2航母+6追猎，对面18腐化；940.2s追猎
  增至8、舰队12，对面19腐化+1大龙。主防簇为主矿4塔+8电池，舰队没有
  再在外矿被秒，但18-19腐化仍能正面换穿当前2门追猎补员。
- 两航母再次最先消失：948s尚余1航母，956s已经0；航母每艘250气，面对
  腐化是高成本劣势交换。追猎从940s的8只跌到964s仅1只，2座Gateway来不及
  补回；随后暴风由12在980/996/1004/1012s依次降为11/7/4/0。
- 940.4s敌19腐化在场时触发`O359:停气转矿(气502,矿195)`，方向与当前需要
  追猎/暴风持续补员相反。另一个行为缺口是Tempest抵达强掩体后仍持续注册
  `PathUnitToTarget`并continue，没有在塔电簇上空站定射击，实际主要靠塔/
  追猎消耗腐化。
- 新认证序列为 **负→胜→胜→负→负→负→负→负**；滚动最近5局现为
  **0胜5负**、连胜0。当前代码已从科技死锁转到可重复的后期腐化海配方问题。

### O421 已落地（有效败局的4项优化）

1. **腐化海扩到4座Gateway**：Zerg Macro可见腐化≥8时，Gateway/Warpgate
   总目标从2提高到4；走常规BuildStructure并尊重Nexus基金，不在掉矿独占窗
   抢400矿。目标是把追猎补员吞吐翻倍，靠动态`1.5×腐化`上限继续生产。
2. **腐化≥4禁止新航母**：在carrier quota执行后再次裁剪配方，Zerg Macro
   可见腐化≥4时移除CARRIER并取消quota的250气强制存款；现有航母不自杀，
   但新增气全部转暴风/追猎。
3. **腐化窗禁止停气转矿**：同一可见腐化≥4门接入O359触发条件；保留采气
   供追猎50气和暴风125气，非Macro与腐化<4的矿气倒挂语义不变。
4. **抵达强掩体后站定还火**：暴风距选定强塔电簇≤6格且已有射程内目标时，
   从继续Path切为按大龙→腐化优先的AMove集火；尚未到位或无可攻击目标才继续
   撤退路径。这样塔、电池、追猎与暴风DPS在同一火力圈共同交换。
5. 验证门：`py_compile`通过；生产/战斗定向 **636 passed**；完整项目测试
   **929 passed, 1 skipped**；production/combat/tempest/main import smoke通过。
   下一局验收：腐化≥8后Gateway向4增长、腐化≥4后零新航母与零O359停气、
   暴风到强掩体后持续反击，追猎不再在8→1的16s窗口内断层。

## O422 Zerg Macro 第九轮（Defeat 1214.9s；瞬时腐化门被视野洞击穿）

- 正式有效 **Defeat 1214.9s**。O421的禁航母和掩体还火已有部分收益：
  900s我方13暴风+8追猎、0航母，对面15腐化；956-1076s舰队稳定维持12暴风，
  没有像o421在980-1012s立即清零。峰值舰队13、基地峰值3，16舰队出击门
  与12舰队四矿门继续通过。
- 但Gateway扩产未实际形成。900s腐化15条可见时仍只有2门，尽管矿195足够
  第3门；常规`BuildStructure`与同帧单位/塔消费竞争，未获得确定落地优先级。
  920s腐化10+大龙4，追猎由8跌到3；940s腐化离开视野，Gateway目标立即退回2。
- 视野洞是主因：腐化15条在900s可见，940-1076s大部分时间不可见，1100s
  以20腐化+8大龙重新显形，间隔约160s。三项O421机制都只吃当帧可见值：
  4门目标回退、禁航母门回退、保持采气门回退。990.0s因此仍触发
  `O359:停气转矿(气503,矿40)`，1100s重现时矿已-30，无力补Gateway/追猎。
- 塔投资仍偏重：619/675/900s舰队5/6/13时塔20/20/22；原10塔帽在舰队4
  即释放，约1800矿额外塔投资挤压了4门与追猎的矿物窗口。终局0基地、0农民、
  仅1先知；滚动最近5局仍 **0胜5负**、连胜0。

### O422 已落地（有效败局的4项优化）

1. **生产侧腐化信用窗180s**：新增独立腐化峰值台账，基于`aa_peak_sticky`
   但Zerg Macro窗口从60提高到180s，覆盖本局160s迷雾洞；其他组合保持60s。
   4门目标、禁航母、保持采气三者统一读取同一信用值，避免各自抖动。
2. **4门改critical直钉**：腐化信用≥8且当前门数<4时，不再注册普通
   `BuildStructure`等待行为排序，改走`_dispatch_structure(..., critical=True)`；
   成功派工记录`O422:腐化信用扩追猎产能`，Nexus基金期仍禁止抢矿。
3. **腐化信用立即解除既有停气**：信用≥4不仅禁止新O359触发，也直接进入
   已激活`_o358_gas_pull`的解除条件；本帧把停气工归还采集，不再等气<250或
   60s保险丝。追猎/暴风气源与腐化威胁同帧恢复。
4. **10塔帽保持到16舰队**：Zerg Macro舰队<16时全局常规塔硬顶10；达到16
   后恢复原舰队≥12/塔20的后期帽。新矿首座survival塔仍豁免，目标把第11-22
   座塔的1800矿转成2座Gateway和持续追猎补员。
5. 验证门：`py_compile`通过；生产/战斗定向 **636 passed**；完整项目测试
   **929 passed, 1 skipped**；production/combat/tempest/main import smoke通过。
   下一局验收：首次腐化≥8后180s内Gateway保持4目标、腐化离视野仍零航母/
   零停气、已激活停气立即解除、舰队<16常规塔≤10。

## O423 Zerg Macro 第十轮（Defeat 1334.7s；4门启动仍晚于首个腐化海）

- 正式有效 **Defeat 1334.7s**。中期编成一度明显改善：699.1s为8暴风+
  2航母+10追猎、3基地，未发生O302/O390，常规塔约12。711.2s第一批空军
  显形时却已是15腐化+6飞龙，对当前配方形成满额压制。
- 生产侧腐化信用与critical接线本身通过：717.8s首次记录
  `O422:腐化信用扩追猎产能(Gateway=2→4)`，之后742/824/840/855/875s
  持续重试，最终875s实体门数才从2增到3。但第一轮接战已经在711-763s完成：
  航母2→0，暴风8→1，追猎11→5；门的46s建造与临战矿物竞争决定了“看到8条
  腐化再扩门”天然来不及。
- 180s信用正确跨过迷雾：腐化数量从15逐步降到5并在827s离视野，4门目标仍
  持续，没有回退2；腐化期未出现新航母和O359停气。O422解决了抖动，但无法
  倒流时间救首接触。
- 另一旁路在904.5s暴露：舰队仅3时`O380:舰队未成型豁命推进窗`直接把
  `_force_push`置True，随后触发`O302(fleet=3)`，绕过Macro 16舰队门。
  该次不是首轮团灭主因，但会把重建舰队继续送出。终局0基地、2农民、仅1先知；
  滚动最近5局仍 **0胜5负**、连胜0。

### O423 已落地（有效败局的3项优化）

1. **4门从临战响应改为500s预建**：Zerg Macro在`t≥500`且真实舰队≥4时，
   即使腐化尚未显形也把Gateway/Warpgate目标提高到4；腐化信用≥8仍作为另一
   触发条件。目标是让两座追加门在711s首腐化海之前完成，而不是接战后施工。
2. **16暴风前不造航母**：Zerg Macro只要真实暴风<16就裁剪CARRIER配方；达到
   16后若腐化信用<4才恢复后期航母。封住o423两艘航母在首轮腐化海中先蒸发
   的500气损失，把中期全部气转暴风/追猎。
3. **Macro禁用O380豁命窗**：新增组合门，Zerg Macro不再以2-4舰队开启60s
   desperation push；普通/强推/经济打击继续统一服从16舰队门。其他组合O380
   语义不变。
4. 验证门：`py_compile`通过；生产/战斗定向 **636 passed**；完整项目测试
   **929 passed, 1 skipped**；production/combat/tempest/main import smoke通过。
   下一局验收：500s/舰队4后Gateway提前完成4座、暴风<16时航母为0、全局零
   O380/O302旁路；首腐化海到来时目标编成为≥8暴风+≥12追猎+4门补员。

## O424 Zerg Macro 第十一轮（Defeat 1118.2s；反腐化通过，败因转地面换家）

- 正式有效 **Defeat 1118.2s**。O423三项硬验收全部通过：731.2s已有4座
  Gateway、8暴风+12追猎、0航母、3基地；全局无O380/O302。相较o423同阶段
  2门、8暴风+2航母+11追猎，产能与配方已按设计前置。
- 首轮腐化海被正面打退：约835s仍有15暴风+10追猎，对面腐化只余5；
  o423在763s已只剩1暴风，本局同阶段舰队反而继续增长，证明4门预建、禁中期
  航母、腐化信用保持采气和掩体还火的组合链首次完整通过。
- 新败因是被动防守导致经济换家。758.2/774.5s两座分矿连续被10地面兵力
  抄矿，约798s基地3→1；舰队在空战中占优却没有主动反打或阻断敌地面续波。
  835s基地仅1、工人34，恢复基金暂停生产；875s才补回二矿，但经济已被滚压。
- 绝对腐化撤退门也过保守：835s我方15暴风+10追猎，对面仅5腐化，仍因
  “腐化≥4”把暴风拉回全局最强主防簇，无法利用25对空战力救外矿。之后经济
  枯竭，追猎10→0；1069s仍有13暴风但仅1基地16农，对面16腐化+完整地面海，
  最终0基地、3农民、0军队。
- 单基地重建期间出现多次Nexus工人提前钉点干等（846/1041/1058/1103s），
  银行只有5-125矿时农民离矿线，进一步推迟400矿窗口。滚动最近5局仍
  **0胜5负**、连胜0，但失败层级已从“舰队首轮团灭”迁移到“优势舰队未转化”。

### O424 已落地（有效败局的3项优化）

1. **Zerg Macro黄金反打窗**：650–780s、真实舰队≥8、追猎≥10且腐化信用≤3
   时开启一次主动强推，复用既有commit/热点召回/AA重评；目标是在电脑腐化海
   与地面连续波成型前斩经济。腐化信用≥4或越过780s即不开窗。
2. **腐化撤退改相对兵力判据**：飞蛇>0仍无条件全局预撤；仅腐化时要求
   `腐化×2 ≥ 暴风+追猎`才撤到最强塔电簇。像o424的5腐化对25我军不再放弃
   外矿；o423的15腐化对19我军仍撤。敌进入单舰15格圈的局部微操闸保持。
3. **单基地重建攒满400再派工**：`lost_base`基金下当前基地≤1且矿<400时，
   ExpansionController不再因基金强制`prioritize`；工人继续采矿，银行满400
   后再派往安全矿点。首扩和当前≥2基地的重建预走位语义不变。
4. 验证门：`py_compile`通过；生产/战斗定向 **636 passed**；完整项目测试
   **929 passed, 1 skipped**；production/combat/tempest/main import smoke通过。
   下一局验收：650–780s满足编成时出现Macro黄金O302、优势空军不因少量腐化
   全退、单基地矿<400时零Nexus idle_builder并更快恢复二矿。

## O425 Zerg Macro 第十二轮（Defeat 1477.2s；首次建立胜势但终结失败）

- 正式有效 **Defeat 1477.2s**。O424黄金反打实机通过：730.2s以11舰队+
  12追猎触发`O302(黄金窗=True)`；795s增长到14暴风+12追猎，对面仅3腐化。
  相对撤退门也通过，优势空军没有因少量腐化放弃外矿。
- 主战阶段首次形成决定性优势：1068.8s我方19暴风+10追猎、3基地，对面
  14腐化且地面主力变薄；1213s仍有16暴风，而敌可见只剩1大龙、零结构。
  新配方已能打穿首腐化海并把电脑压到近乎清空。
- 败局来自残敌终结。录像显示电脑在910.8/991.3/1077.9s持续补孵化场，
  1233.3s又在我方“终结模式”中拍出新孵化场；之后1316/1395s继续重建。
  1450s电脑已重新攒回16腐化+8感染虫+3大龙，最终翻盘。
- 现有`_terminal_cleanup_target`先取全部`enemy_structures`，其中包含已摧毁但
  未复见的迷雾结构记忆，舰队可能反复奔向旧坐标；无结构时又先追可见残兵
  （1213s的一条大龙），理论扩张点轮巡排最后，且覆盖整张地图。电脑80-100s
  就能重拍孵化场，现有巡逻周期明显过长。
- 新认证最近5局仍 **0胜5负**、连胜0；但这是复验阶段第一场“主战胜、收尾负”，
  剩余攻坚已从兵力配方收敛到经济目标清理。

### O425 已落地（有效败局的3项优化）

1. **已知孵化场绝对优先**：终结目标第一优先改为`_known_enemy_townhalls()`，
   并选最外围已知基地；电脑一旦新孵化场被侦察，16+暴风直接斩经济，不再先打
   孢子/残兵。
2. **普通结构只认当前可见**：非Townhall结构候选过滤为当前位置可见，避免已被
   摧毁的迷雾Spore/Spine/Pool记忆把舰队钉在旧坐标；可见结构仍排在工蜂之前
   立即清除。
3. **敌侧六矿巡逻排在残兵前**：无已知经济、可见结构和工蜂时，按距敌出生点
   从近到远只轮巡6个高概率扩张点；巡逻完成前不追单个大龙/运输王虫。相较全图
   扩张点轮巡，大幅压缩孵化场重拍后的发现窗口。
4. 验证门：`py_compile`通过；生产/战斗定向 **638 passed**；完整项目测试
   **931 passed, 1 skipped**；production/combat/tempest/main import smoke通过。
   下一局验收：终结期优先击杀新孵化场、无经济目标时舰队在敌侧六矿连续轮巡、
   不再被旧迷雾结构或单个残兵拖住，胜势必须在电脑下一轮remax前结束。

## O426 Zerg Macro 第十三轮（Defeat 956.9s；终结未进场，早地面波击穿）

- 正式有效 **Defeat 956.9s**。该局没有进入终结验证：电脑地面波在562.1s
  以11单位压一矿、572.9s增至15单位压另一矿；当时我方3基地、6-8暴风，
  但两座分矿局部只有1/2塔，618s先掉一矿、687s进一步基地2→1。
- 4门预建与首波资源发生冲突。528/537s连续派第3/4 Gateway，554s四门实体
  完成；562s首波到脸时矿240、气0，四门只有2追猎可用。门本身吃掉300矿，
  而气体已被暴风生产耗尽，临战额外产能不能转化为战力。
- 暴风行为也过度回避地面：570-610s敌以6-8刺蛇+2-3感染虫为主、无腐化；
  现有局部AA判据把感染虫视为无条件撤退触发，9暴风退向塔簇而不持续救外矿。
  基地虽于771s补回二矿，经济已断，956s舰队归零。
- 单基地重建改动通过：687s基地1、银行65-150期间没有Nexus工人提前钉点，
  771s银行达标后才完成新基地；本局Nexus idle_builder仅在后期再次掉矿时出现。
  滚动最近5局仍 **0胜5负**、连胜0。

### O426 已落地（有效败局的3项优化）

1. **4门预建后移到580s/8舰队**：原500s/4舰队改为同时满足`t≥580`与真实
   舰队≥8；腐化信用≥8仍可立即触发。目标先把528-537s的300矿留给首地面波
   防守，再在预计711s首腐化前完成第3/4门。
2. **无气地面波直产狂热屏障**：Zerg Macro可见地面作战单位≥10、腐化信用≤3、
   狂热<8，且买不起追猎但买得起狂热时，空闲Gateway直接训练狂热；记录
   `O426:无气地面波直产狂热屏障`。用纯矿单位填满闲置4门，挡蟑螂/刺蛇贴矿。
3. **感染虫撤退改舰队规模门**：飞蛇在15格内仍无条件撤；感染虫单独出现时，
   仅真实暴风<8才触发全局局部撤退。8+暴风继续在强塔电簇或热点基地站定输出，
   不再因3感染虫放弃两座分矿；腐化≥3的局部撤退门不变。
4. 验证门：`py_compile`通过；生产/战斗定向 **638 passed**；完整项目测试
   **931 passed, 1 skipped**；production/combat/tempest/main import smoke通过。
   下一局验收：首地面波前不提前拍4门、气枯时狂热增长、8+暴风面对感染虫仍
   救矿；若进入胜势，再继续验收O425孵化场优先终结。

## O427 Zerg Macro 第十四轮（Defeat 1044.8s；黄金推进召回门过高）

- 正式有效 **Defeat 1044.8s**。O426早地面修复部分通过：711s仍保持3基地，
  11暴风+4追猎+5狂热；相较o426同阶段基地1，第一次地面波没有立即双矿坍塌。
  4门在580s/8舰队后完成，气枯狂热屏障使地面数量明显增加。
- 黄金窗也实际触发：746.3s为11暴风+13追猎，`O302(黄金窗=True)`；但750.3s
  外矿出现5地面、772.8s第二波升到12地面。黄金推进沿用成型舰队的普通召回
  门：舰队≥12时阈值25，因此两波都低于召回线，主力继续commit。
- 经济因此被换掉：763s基地3→2，后续小股4-5地面反复拆矿；虽779-900s仍有
  13暴风，基地长期只有2、局部塔3-5。956s敌108 supply再次压境，1012s舰队
  13→1，最终0基地0农。
- 狂热者也随全军出击：黄金窗前有5狂热，763s接战后只剩1，外矿缺少廉价地面
  屏障。O426感染虫判据没有重现全撤问题；本局主因是黄金骚扰被实现成all-in。
  滚动最近5局仍 **0胜5负**、连胜0。

### O427 已落地（有效败局的3项优化）

1. **Macro黄金窗截止780→750s**：窗口仍从650s开始，但最晚750.0s结束；像
   o427的746s出击只保留约4s探压，750s波到矿即回归普通防守判据。o425的730s
   成功模板仍保留20s进攻窗口。
2. **黄金骚扰基地5地面即召回**：新增Macro黄金专用召回上限5，覆盖普通
   14/25门；`_hot_base_anchor(min_threat=5)`一旦命中立即把空军拉回热点基地。
   经济打击10门和普通推进门不变。
3. **黄金窗狂热者留守**：仅暴风/航母与追猎参与Macro黄金推进，ZEALOT目标
   强制改为`_defend_anchor()`；保留5-8个纯矿肉盾在塔电簇与矿线间拦蟑螂/狗。
   追猎仍随舰队提供腐化护航。
4. 验证门：`py_compile`通过；生产/战斗定向 **638 passed**；完整项目测试
   **931 passed, 1 skipped**；production/combat/tempest/main import smoke通过。
   下一局验收：黄金O302在750s自动结束、基地威胁5立即召回、狂热者数量不因
   黄金推进清零；若主战获胜，再验收O425敌侧六矿终结。

## O428 Zerg Macro 第十五轮（Defeat 1187.9s；追猎资源流断链）

- 正式有效 **Defeat 1187.9s**。O427黄金回防没有机会进入验收：该局追猎始终
  未达到黄金门。663s为6暴风+1追猎，843s为11暴风+1追猎；基地于779s先掉一矿，
  后续经济在地面/腐化混合波中逐步崩溃。
- 4门仍启动过晚。当前预建要求580s且真实舰队≥8，本局舰队8约731s才达到，
  773s才首次记录`Gateway=2→4`派工；临战资源/落位竞争下至终局实体仍只有2门，
  与o423“看到威胁后施工来不及”同谱系。
- 追猎气源也被截断：617.4s仅6暴风+约1追猎时触发O359停气；虽然654s解除，
  首批护航窗口已经错过。后期相反又因腐化信用保持全采气，气体从843s的435
  涨到终局1444，而矿物最终3，出现“前期缺气、后期烂气”的双向错位。
- 956s连续损失4暴风，之后舰队仅7；1098s再掉经济，1188s0基地、1农、0军队。
  滚动最近5局仍 **0胜5负**、连胜0。

### O428 已落地（有效败局的3项优化）

1. **580s无条件预建4门**：Zerg Macro`t≥580`即把Gateway/Warpgate目标升4，
   不再等待舰队8；腐化信用≥8仍可更早触发。相比500s旧版避开562s首地面波，
   又比773s实机启动提前约193s。
2. **护航保气设置600上限**：t≥500、舰队≥4且追猎<12，或腐化信用≥4时，
   在气<600阶段禁止O359；气≥600后允许停气转矿，把超额气工转回矿线。
   目标既防617s追猎缺气，又防终局1444气/3矿。
3. **首6追猎前暂停新舰队订单**：t≥500、真实舰队≥4而追猎<6时，从spawn配方
   暂时移除TEMPEST/CARRIER并取消动态save-up；现有舰队照常作战，星门短暂停单，
   让前300气优先变成6追猎。达到6后自动恢复纯暴风生产。
4. 验证门：`py_compile`通过；生产/战斗定向 **638 passed**；完整项目测试
   **931 passed, 1 skipped**；production/combat/tempest/main import smoke通过。
   下一局验收：580s后4门实体按时完成、追猎先达6再恢复暴风、护航期零O359且
   气≥600后允许矿气再平衡；随后继续验收黄金回防与终结巡逻。

## O429 Zerg Macro 第十六轮（Defeat 1023.4s；护航抑制过长错过黄金窗）

- 正式有效 **Defeat 1023.4s**。580s无条件4门和600气上限均实机通过：
  621/637s第3/4门派工并落成；637.4s气603时O359获准触发，640.6s气593即
  解除，证明上限边界有效。
- 但“首6追猎前停舰队”过度。667s只有5暴风+3追猎，舰队订单继续暂停；
  直到800s追猎达到6才恢复，而黄金窗已在750s关闭。815s仍只有5暴风+6追猎，
  电脑已经完成下一轮地面/腐化规模。
- 资源仍偏向非战斗支出：农民峰值65，506s舰队2时塔14；两者较目标分别多5农
  和6塔，至少占用1150矿。同期矿物长期13-200、气体600-1051，星门虽5座却
  无矿恢复暴风。
- 909/915s两座分矿再被4地面小队抄矿；976s基地1、5暴风+3追猎，对面9腐化+
  26地面，1023s全失。滚动最近5局仍 **0胜5负**、连胜0。

### O429 已落地（有效败局的3项优化）

1. **舰队抑制改为首4追猎/650s双释放**：仅500–650s且真实舰队≥4、追猎<4
   时暂停新暴风；追猎达到4或时间>650任一满足即恢复。相比首6追猎，把o429
   的恢复点从800s前移至少150s，同时保留初始护航气体优先。
2. **Zerg Macro农民封顶60**：常态`_build_probes`目标从全局70改为60，硬经济
   底线和一/二矿40农恢复逻辑不变；省下第61-65探机的250矿及后续供给，为
   暴风/追猎/重建Nexus留窗。
3. **16舰队前常规塔帽8**：原10降到8；舰队≥16后仍恢复20顶，新矿首座
   survival塔继续豁免。目标避免o429舰队2时塔14，将第9-14塔的900矿转军队。
4. 验证门：`py_compile`通过；生产/战斗定向 **638 passed**；完整项目测试
   **931 passed, 1 skipped**；production/combat/tempest/main import smoke通过。
   下一局验收：追猎4或650s即恢复暴风、农民≤60、前16舰队常规塔≤8，并在
   650–750s重新形成黄金反打编成。

## O430 Zerg Macro 第十七轮（Defeat 1346.1s；主战成型，终结/预算旁路）

- 正式有效 **Defeat 1346.1s**。O429时盒与工人帽通过：工人峰值61（单帧在产
  越1），667s抑制已因>650s解除；855s形成13暴风+12追猎、3基地，对面16腐化，
  主战编成再次达到可战档。
- 但844.3s再次在视野空窗触发`O403:残敌终结模式(fleet=16,可见结构=0)`；
  同帧/随后敌16腐化+完整地面海显形。Zerg Macro终结最早800s过早，把中局
  暂时不可见误判为残敌阶段，绕过集结与热点防守。
- 塔帽仍未真实生效：506/675/844s舰队2/6/13时塔11/17/21。原因是
  `_dispatch_structure`只在`not survival_exempt`时执行Zerg Macro cap，
  新矿生存塔通道可持续绕顶；21塔相对目标8多1950矿。
- 矿气倒挂继续扩大：956-1294s气1130-1360，而矿40-315；虽O359可触发，
  30s cooldown使高气低矿期仍有长空窗。1121s只剩13暴风、0追猎；后续经济
  被地面波压缩，1346s0基地0农、余2暴风。滚动最近5局仍 **0胜5负**。

### O430 已落地（有效败局的3项优化）

1. **Zerg Macro终结最早800→1100s**：结构/农民/作战单位阈值保持10/20/12，
   只后移时间门；避免844s中局视野洞误触发，仍覆盖o425在1200s后的真实清场。
2. **塔帽覆盖survival通道**：`zerg_macro_cannon_capped`在手工派工入口不再因
   `survival_exempt`跳过；舰队<16时总塔达到8即停止任何新塔，新矿首塔也必须
   服从全局预算。舰队≥16后恢复20顶。
3. **800气紧急转矿绕冷却**：Zerg Macro气≥800且矿<200时，即便处于O359的
   30s cooldown也允许重新触发停气；解除仍走气<250/保险丝规则。目标把
   1130-1360死气持续转为追猎/Nexus所需矿物。
4. 验证门：`py_compile`通过；生产/战斗定向 **638 passed**；完整项目测试
   **931 passed, 1 skipped**；production/combat/tempest/main import smoke通过。
   下一局验收：1100s前零O403、舰队<16塔≤8、高气低矿时O359不受冷却空窗；
   主战获胜后继续验收O425孵化场终结顺序。

## O431 Zerg Macro 第十八轮（Defeat 1255.3s；Q5误杀16暴风残局）

- 正式有效 **Defeat 1255.3s**。终局并非无战力：基地0、农民19、矿55，
  **16暴风仍完整在场**，supply 83/112；电脑可见约59单位。Q5在基地归零的
  同帧直接leave，把换家/清孵化场/等待战场结算全部截断。
- 触发原因是O192规则：t≥600后，0基地重建可行性额外要求工人≥3且银行≥250；
  本局矿55因此`viable=False`，逻辑完全不看现役舰队。对普通1农残局合理，
  对16暴风是确定性误判。
- 其余改动部分通过：1100s前没有O403终结误触发；工人峰值60；高气峰值784，
  没有重现1360气淤积。硬塔帽也把o430峰值21降到14，但仍有PSD/main-siege等
  行为层旁路，后续继续观察。
- 主战期间956s达到16暴风、3基地；直到1197s地面小队持续拆矿才压到基地1，
  1255s瞬间归零。滚动最近5局仍 **0胜5负**、连胜0。

### O431 已落地（有效败局的3项优化）

1. **0基地12+舰队获得120s最后攻坚窗**：Q5首次判定不可重建时，真实
   TEMPEST+CARRIER≥12则记录deadline=`now+120`并暂不leave，事件
   `O431:0基地大舰队最后攻坚窗`。若期间Nexus恢复，deadline立即销账。
2. **舰队跌破12可提前结束**：last-stand每帧复核真实在场舰队；跌到11或窗口
   到期且仍不可重建，Q5恢复原离场，避免无意义拖局。12/11与deadline边界均有
   纯函数测试。
3. **最后攻坚强制终结目标**：窗口激活时CombatManager设置commit并直接走
   O425目标优先级（已知孵化场→可见结构→工蜂→敌侧六矿→残兵），不再防守
   已不存在的基地。司令显式defend/retreat仍有更高优先级。
4. 验证门：`py_compile`通过；生产/战斗定向 **639 passed**；完整项目测试
   **932 passed, 1 skipped**；production/combat/tempest/main import smoke通过。
   下一局验收：0基地12+舰队不立即Q5、120s内持续斩孵化场；恢复Nexus则退出
   窗口，舰队跌破12则安全离场。

## O432 Zerg Macro 第十九轮（Defeat 1084.6s；Q5门正确，反腐化仍不足）

- 正式有效 **Defeat 1084.6s**。O430/O431基础门通过：615s塔严格8、工人52；
  1100s前无O403误触发。黄金窗727.5s以8暴风+12追猎触发并在750s结束，
  771/790s地面波到矿后主力进入召回。
- 但腐化海仍持续换穿护航。791s我方12暴风+3追猎，对面17腐化；956s通过4门
  补到12暴风+7追猎+6狂热、2基地，仍有恢复机会；随后1007s起下一轮混合波
  连续拆矿，1085s仅余4暴风、0基地、3农。
- Q5新门按设计工作：基地归零时舰队已跌到4，低于12，因此没有开启120s最后
  攻坚，正常判负；它避免误拖无战力残局，但本局没有复现o431的16暴风0基地场景。
- 当前12追猎线在17腐化面前余量不足，且4座Gateway补员速度跟不上战损；纯
  暴风本身被腐化重甲加成克制。滚动最近5局仍 **0胜5负**、连胜0。

### O432 已落地（有效败局的3项优化）

1. **Macro追猎目标12→16**：早期直产与spawn escort共用新地板；追猎<16时
   持续补员，腐化动态`1.5×`更高上限仍保留。目标给17腐化多4个地面对空缓冲。
2. **腐化信用≥8时Gateway目标4→6**：580s常态预建仍为4门；腐化峰值进入信用
   后critical追加第5/6门，把追猎补员吞吐再提高50%。Nexus基金期继续让位。
3. **腐化海混入最多4虚空舰**：Zerg Macro腐化信用≥8且场上/在产虚空<4时，
   spawn首位加入VOIDRAY(p0,0.4)；虚空对重甲腐化有专门爆发，达到4后自灭。
   禁航母与暴风主C语义不变。
4. 验证门：`py_compile`通过；生产/战斗定向 **639 passed**；完整项目测试
   **932 passed, 1 skipped**；production/combat/tempest/main import smoke通过。
   下一局验收：腐化信用≥8后Gateway向6增长、追猎向16补、虚空舰1-4出场，
   17腐化窗口不再把护航快速清空。

## O433 Zerg Macro 第二十轮（Defeat 953.6s；反腐化转换晚20-60s）

- 正式有效 **Defeat 953.6s**。录像开矿为我方二/三矿213.0/387.0s，电脑
  二/三/四矿83.8/394.5/560.6s。715.2s首批空军显形：我方8暴风+12追猎，
  对面6腐化；735.3s腐化升12，我方已降到6暴风+7追猎。
- 现有虚空/六门转换门仍是腐化信用≥8，因此715s不触发；735s越门后才开始
  下单，首虚空775.4s出现。此时对面已13腐化+8刺蛇，基地3→2，反制晚约
  20-60s。795/803s连续损失2+2暴风，835s舰队归零。
- 六门扩产同样晚：715s仍4门，首腐化6条已足以逼迫配方转换，但当前门等到8条。
  后续恢复基金在低舰队状态下暂停生产，900s已仅1基地5农，终局0基地3农。
- 最近5个Zerg Macro样本仍 **0胜5负**、连胜0，尚未通过严格认证。

### O433 已落地（有效败局的3项优化）

1. **虚空转换门腐化8→4**：Zerg Macro腐化信用≥4且虚空<4即把VOIDRAY加入
   spawn首位；覆盖715s的6腐化首接触，预计首虚空从775s提前到约755s。
2. **六门扩产门腐化8→4**：常态580s预建4门不变；腐化信用≥4即把
   Gateway/Warpgate目标提高到6，提前两门追猎补员窗口。
3. **4虚空前暂停新暴风/航母**：腐化信用≥4且虚空<4时，从spawn暂时移除
   TEMPEST/CARRIER，让5星门并行转虚空；4虚空达成后自动恢复暴风主C，
   航母仍服从既有禁用门。
4. 验证门：`py_compile`通过；生产/战斗定向 **639 passed**；完整项目测试
   **932 passed, 1 skipped**；production/combat/tempest/main import smoke通过。
   下一局验收：首见4-7腐化即六门/虚空转换，4虚空前零新暴风/航母，首轮
   12腐化窗口不再把8暴风+12追猎快速清空。
